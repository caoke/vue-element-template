  ...
  <div class="export-excel">
    <div>
      ...
      <el-select v-model="bookType">
        <el-option v-for="item in bookTypes" :key="item" :value="item" :label="item" />
      </el-select>

      <el-button v-permission="['edtior', 'admin']" type="primary" style="margin-left: 20px;" @click="download">导出</el-button>
    </div>
