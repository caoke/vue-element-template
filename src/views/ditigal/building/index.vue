  ...
  <div class="app-container building">
    ...
    <el-form :model="form" :inline="true">
      <el-form-item label="楼栋名称">
        <el-input v-model="form.name" placeholder="楼栋名称" />
      </el-form-item>
    ...
    <div class="table-section">
      ...
      <el-table :data="tableData">
        <el-table-column v-for="item in ths" :key="item.prop" :label="item.label" :prop="item.prop" />
    ...
    <el-dialog title="新增楼栋" :visible.sync="dialogVisible" custom-class="custom-dialog" @closed="handleClosed">
      <el-form ref="dialogForm" :model="dialogForm" label-width="120px" :rules="dialogRules">
        ...
        <el-form-item label="楼栋层数" prop="floors">
          <el-input-number v-model="dialogForm.floors" :min="1" :precision="0" placeholder="请输入楼层数" />
        </el-form-item>
